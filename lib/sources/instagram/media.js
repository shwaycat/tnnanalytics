...
Media.prototype.createDelta = function(user, key, value, timestamp, callback) {
  ...
  body[key] = parseInt(value, 10) - parseInt(body[key], 10);
...
Media.prototype.modifyByDelta = function(callback) {
  ...
  keystone.elasticsearch.search({
    ...
    body: {
      ...
      aggregations: _.reduce(_.keys(DELTA_FIELDS), function(aggs, fieldName) {
    ...
    _.each(_.keys(DELTA_FIELDS), function(fieldName) {
