        ...
        function(done) {
          ...
          google.pager('nextLink', requestOpts, function(row, next) {
            ...
            bulkUpdater.add(DELTA_BULK_CREATE_ACTION,
              buildBulkCreateDelta(profile, row, data, 'sessions', 4));
            bulkUpdater.add(DELTA_BULK_CREATE_ACTION,
              buildBulkCreateDelta(profile, row, data, 'bounces', 5));
            bulkUpdater.add(DELTA_BULK_CREATE_ACTION,
              buildBulkCreateDelta(profile, row, data, 'pageViews', 6));
            bulkUpdater.add(DELTA_BULK_CREATE_ACTION,
              buildBulkCreateDelta(profile, row, data, 'users', 7));
            bulkUpdater.add(DELTA_BULK_CREATE_ACTION,
              buildBulkCreateDelta(profile, row, data, 'sessionDuration', 8));
