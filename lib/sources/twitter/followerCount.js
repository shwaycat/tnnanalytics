...
FollowerCount.pull = function(user, callback) {
  ...
  var client = new twitter({
      ...
      params = { user_id: user.services.twitter.profileId };
//TODO add screenname to params
  client.get('users/show', params, function(err, twitterUser, response) {
    ...
    FollowerCount.findOneWithDelta(twitterUser.id_str, function(err, followerCount) {
      if(err) return callback(err);
