 ...
 */
function ElasticsearchBulkManager(actionLimit, defaultAction) {
 ...
 * @see https://www.elastic.co/guide/en/elasticsearch/reference/1.x/docs-bulk.html
 */
ElasticsearchBulkManager.prototype.addSource = function(source) {
  if (!this.defaultAction) {
    throw new Error("defaultAction not set");
  }

  this.bulkUpdates.push(this.defaultAction, source);
  this.actionCount++;
