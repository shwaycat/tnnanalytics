  ...
  User.model.getAccountRootInfo(user.accountName, function(err, accountRoot) {
    ...
    keystone.elasticsearch.search({
      ...
      if(buckets && buckets.length) {
        ...
        summary.changeInAcquisition = _.reduce(_.values(summary), function(memo, num){ return memo + num; }, 0) - mxm.getFirstNonZeroValue(data);
        summary.changeInAcquisitionPercent = (((summary.changeInAcquisition / mxm.getFirstNonZeroValue(data)) * 100) || 0).toFixed(2);
      }
